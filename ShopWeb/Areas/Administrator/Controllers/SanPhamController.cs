...
namespace WebShop.Areas.Administrator.Controllers
{
    ...
    public class SanPhamController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CapNhat([Bind(Include = "MaSanPham, TenSanPham, GiaSanPham, NgayNhap, SoLuongTon, MoTa, MaLoaiSanPham, MaHangSanXuat")] SanPham sanpham, IEnumerable<HttpPostedFileBase> upload)
        {
            if (ModelState.IsValid)
            {
                
                SanPham sp = db.SanPhams.Single(s => s.MaSanPham == sanpham.MaSanPham);
